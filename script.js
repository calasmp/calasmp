const t = {
  id:{
    nav_home:'Beranda',nav_about:'Tentang',nav_store:'Toko',nav_media:'Media',nav_rules:'Aturan',
    ...
    about_sub:'Server SMP Indonesia yang ramah semua kalangan — dari pemain premium hingga non-premium, semua punya tempat di sini.',
    f1t:'No Premium',f1d:'Akun gratis atau cracked? Tetap bisa main di sini tanpa hambatan.',
    f2t:'Java & Bedrock',f2d:'Crossplay lintas platform. PC, HP, konsol semua terhubung.',
    f3t:'Sistem Ekonomi',f3d:'Bangun kerajaan dagangmu dengan sistem ekonomi in-game yang lengkap.',
    f4t:'Survival',f4d:'Survival klasik dengan event musiman dan konten ekstra yang seru.',
    ...
    rules_eye:'Peraturan',rules_h2:'Aturan Server',
    rules_sub:'Harap baca dan patuhi semua aturan berikut agar pengalaman bermain tetap menyenangkan untuk semua orang.',
    rule1_title:'Server Rules',rule2_title:'Chat Rules',
    foot_tag:'Server SMP Indonesia terinspirasi Donut SMP, untuk semua orang.',
    foot_nav:'Navigasi',foot_wa:'WhatsApp Group',
    foot_dc:'Discord',foot_rules:'Aturan Server',
    foot_copy:'Tidak berafiliasi dengan Mojang atau Donut SMP.',
    toast_ok:'✓ Disalin ke clipboard!'
  },
  en:{
    nav_home:'Home',nav_about:'About',nav_store:'Store',nav_media:'Media',nav_rules:'Rules',
    tag:'Free-to-Play · Crack All Version',
    ...
    about_sub:'An Indonesian SMP server welcoming all players — premium or non-premium, everyone has a place here.',
    f1t:'No Premium',f1d:'Free or cracked account? You can still play here without any barriers.',
    f2t:'Java & Bedrock',f2d:'Cross-platform crossplay. PC, mobile, console — all connected.',
    f3t:'Economy System',f3d:'Build your trading empire with a full in-game economy system.',
    ...
    rules_eye:'Rules',rules_h2:'Server Rules',
    rules_sub:'Please read and follow all rules below to keep the experience fun for everyone.',
    rule1_title:'Server Rules',rule2_title:'Chat Rules',
    foot_tag:'The Indonesian SMP experience inspired by Donut SMP, for everyone.',
    foot_nav:'Navigation',foot_wa:'WhatsApp Group',
    foot_dc:'Discord',foot_rules:'Server Rules',
...
function draw(){
  ...
  particles.forEach(p=>{
    ...
    ctx.fillStyle=`rgba(42,143,255,${p.a})`;
    ctx.fill();
    p.x+=p.vx;p.y+=p.vy;
